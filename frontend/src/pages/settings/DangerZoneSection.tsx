...
export function DangerZoneSection() {
  ...
  const onDelete = async () => {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : 'falha ao encerrar conta')
      setLoading(false)
    }
  }
  ...
  return (
    <SettingsCard
      ...
      description="Remove seu perfil, participações, votos e integrações. A ação é permanente."
    >
      {!confirming && (
        <button
      ...
      {confirming && (
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <span className="text-sm text-up-text">Tem certeza? Não dá pra desfazer.</span>
