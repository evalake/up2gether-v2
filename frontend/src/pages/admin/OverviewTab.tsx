          ...
          {currentGame ? (
            ...
            >
              {currentGame.cover_url && (
                <img loading="lazy" src={currentGame.cover_url} alt="" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none' }} className="h-14 w-24 rounded-sm border border-nerv-green/30 object-cover" />
              )}
              <div className="min-w-0">
                <div className="truncate font-display text-base text-nerv-text">{currentGame.name}</div>
